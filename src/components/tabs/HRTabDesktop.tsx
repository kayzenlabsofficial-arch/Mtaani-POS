...
export default function HRTabDesktop() {
  ...
  const renderStaffModal = () => isStaffModalOpen && (
    <div className="fixed inset-0 z-[120] flex items-center justify-center bg-slate-900/45 p-4">
      <div className="max-h-[92vh] w-full max-w-4xl overflow-hidden rounded-lg border-2 border-slate-200 bg-white shadow-xl">
        ...
        <form onSubmit={handleSaveStaff} className="max-h-[calc(92vh-76px)] overflow-y-auto p-5">
          ...
          <div className="mt-5 flex flex-col-reverse gap-2 border-t-2 border-slate-200 pt-4 sm:flex-row sm:justify-end">
