...
import { Save, ShieldCheck, RefreshCcw, Download, ScanLine, Printer, Usb, Building2, Check, X, Store, type LucideIcon } from 'lucide-react';
  ...
  return (
    <div className="pb-24 animate-in fade-in w-full">
      ...
      <div role="tabpanel" className="space-y-4">
         ...
         {/* Left: Business Info */}
         <div className={activeSettingsSection === 'business' || activeSettingsSection === 'tills' || activeSettingsSection === 'system' ? 'space-y-4' : 'hidden'}>
         ...
         <div className={activeSettingsSection === 'hardware' || activeSettingsSection === 'owner' || activeSettingsSection === 'system' ? 'space-y-4' : 'hidden'}>
