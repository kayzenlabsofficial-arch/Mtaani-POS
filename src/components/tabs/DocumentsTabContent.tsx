...
export default function DocumentsTabContent() {
  ...
  const todayInput = React.useMemo(() => localDateInput(), []);
  ...
  const isLoadingRecords = !allTransactions || !allRefunds || !allExpenses || !allSupplierPayments || !allCreditNotes || !allSalesInvoices || !allPurchaseOrders || !allReports || !allDailySummaries;
  ...
  const headerCountLabel = isLoadingRecords
    ? 'Loading records'
    : filterType === 'MPESA'
