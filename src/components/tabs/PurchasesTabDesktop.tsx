    ...
    <div className="w-full animate-in fade-in space-y-5 pb-24">
      ...
      {isPOModalOpen && (
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4 pb-safe">
           ...
           <div className="relative z-10 flex max-h-[92dvh] w-full max-w-lg flex-col overflow-hidden rounded-t-2xl border-2 border-slate-200 bg-white shadow-xl animate-in slide-in-from-bottom-full duration-300 sm:rounded-lg sm:zoom-in-95">
                        ...
                        {selectedPO.items.map((item, idx) => (
                           <div key={idx} className="rounded-lg border-2 border-slate-200 bg-slate-50 p-4">
                              <div className="flex justify-between items-start mb-4">
                               ...
                               <div className="grid grid-cols-2 gap-3 pt-4 border-t border-slate-200/50 md:grid-cols-3">
                                 <div>
