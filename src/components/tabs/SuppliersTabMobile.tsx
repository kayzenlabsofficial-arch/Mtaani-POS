...
import SupplierLedgerModal from '../modals/SupplierLedgerModalMobile';
...
export default function SuppliersTabMobile({ setActiveTab }: { setActiveTab?: (tab: string) => void }) {
    ...
    <div className="w-full animate-in fade-in space-y-5 pb-24">
      ...
      {isSupplierModalOpen && (
        <MobileModal
          ...
          header={(
              <div className="flex shrink-0 items-center justify-between border-b-2 border-slate-100 p-5">
