...
export default function ExpenseModalDesktop({
  isOpen,
  onClose,
  expenseForm,
  setExpenseForm,
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center p-0 sm:items-center sm:p-4">
      ...
      <div className="relative z-10 flex max-h-[92dvh] w-full max-w-lg animate-in flex-col overflow-hidden rounded-t-2xl border-2 border-slate-200 bg-white shadow-xl duration-200 sm:rounded-lg">
        ...
        <div className="flex gap-3 border-t-2 border-slate-100 bg-white p-5 sm:p-6">
