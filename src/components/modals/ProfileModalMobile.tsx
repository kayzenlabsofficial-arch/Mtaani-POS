...
export default function ProfileModalMobile({ isOpen, onClose, currentUser }: ProfileModalProps) {
  ...
  return (
    <div className="mobile-vv-overlay fixed inset-0 z-[100] flex items-center justify-center p-4">
      <div className="absolute inset-0 bg-slate-900/60 backdrop-blur-sm" onClick={onClose} />
      
      <div className="mobile-vv-panel bg-white w-full max-w-sm rounded-3xl shadow-elevated relative z-10 flex flex-col overflow-hidden animate-in zoom-in-95 duration-200">
        ...
        <form onSubmit={handleUpdatePassword} className="modal-scroll-padding overflow-y-auto p-6 space-y-5">
