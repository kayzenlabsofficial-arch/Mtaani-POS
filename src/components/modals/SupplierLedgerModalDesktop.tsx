...
export default function SupplierLedgerModalDesktop({ supplier, onClose, onEdit, onPay, shiftId, products }: SupplierLedgerModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-0 sm:p-4 pb-safe">
      ...
      <div className="relative z-10 flex h-full w-full max-w-2xl flex-col overflow-hidden border-2 border-slate-200 bg-white shadow-xl animate-in zoom-in-95 duration-300 sm:h-[85vh] sm:rounded-lg">
         ...
         <div id="printable-content" className="print-document-a4 h-full flex flex-col">
            ...
            {/* List Content */}
            <div className="flex-1 overflow-y-auto p-5 print:p-0 sm:p-6">
                {activeTab === 'INVOICES' && (
      ...
      {isAddCreditNoteOpen && (
        <div className="fixed inset-0 z-[60] flex items-end justify-center p-0 sm:items-center sm:p-4">
            ...
            <div className="relative z-10 flex max-h-[92dvh] w-full max-w-lg flex-col overflow-hidden rounded-t-2xl border-2 border-slate-200 bg-white shadow-xl animate-in zoom-in-95 sm:rounded-lg">
