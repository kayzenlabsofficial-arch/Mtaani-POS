...
export default function ReceiptDetailsModalMobile({ selectedReceipt, setSelectedReceipt, handleRefund }: ReceiptDetailsModalProps) {
  ...
  return (
    <div className="mobile-vv-overlay fixed inset-0 z-50 flex items-center justify-center p-4">
      <div className="absolute inset-0 bg-slate-900/60 backdrop-blur-sm" onClick={() => setSelectedReceipt(null)} />
      <div className="mobile-vv-panel bg-white w-full max-w-sm rounded-xl shadow-elevated relative z-10 flex flex-col overflow-hidden animate-in zoom-in-95 duration-200">
         <div id="printable-content" className="print-receipt-80mm">
           ...
           <div className="modal-scroll-padding p-6 space-y-4 max-h-[40vh] overflow-y-auto no-scrollbar print:max-h-none print:overflow-visible">
