...
export default function AdminVerificationModalMobile({ actionDescription, onSuccess, onCancel }: AdminVerificationModalProps) {
  ...
  return (
    <MobileModal
      ...
      placement="center"
      size="xs"
      panelClassName="rounded-xl border-0"
      bodyClassName="p-6"
      header={(
