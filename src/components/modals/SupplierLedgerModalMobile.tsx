  ...
  if (!invoices || !payments || !creditNotes || !supplierPurchaseOrders) {
    return (
      <div className="mobile-vv-overlay fixed inset-0 z-50 flex items-center justify-center p-0 sm:p-4 pb-safe">
        ...
        <div className="mobile-vv-panel relative z-10 flex h-full w-full max-w-2xl flex-col items-center justify-center gap-4 overflow-hidden border-2 border-slate-200 bg-white shadow-xl animate-in zoom-in-95 duration-300 sm:h-[85vh] sm:rounded-lg">
