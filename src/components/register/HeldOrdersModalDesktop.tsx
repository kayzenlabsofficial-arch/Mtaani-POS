...
export default function HeldOrdersModalDesktop({
  open,
  orders,
  onClose,
  onResume,
  ...
  return (
    <div className="fixed inset-0 z-[120] flex items-end justify-center bg-slate-950/55 p-0 backdrop-blur-sm sm:items-center sm:p-4">
      <div className="flex max-h-[82dvh] w-full max-w-lg flex-col overflow-hidden rounded-t-lg border border-slate-300 bg-slate-50 shadow-2xl sm:rounded-lg">
