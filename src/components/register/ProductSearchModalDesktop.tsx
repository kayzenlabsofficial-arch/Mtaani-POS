...
import { MaterialIcon, ProductTile } from './RegisterSharedDesktop';

export default function ProductSearchModalDesktop({
  open,
  query,
  products,
  recentlyAdded,
  ...
  return (
    <div className="fixed inset-0 z-[95] flex items-start justify-center bg-slate-950/55 p-2 backdrop-blur-sm sm:items-center sm:p-4">
      <div className="flex max-h-[calc(100dvh-1rem)] w-full max-w-2xl flex-col overflow-hidden rounded-lg border border-slate-200 bg-white shadow-2xl sm:max-h-[86dvh]">
