import { MaterialIcon } from './RegisterSharedMobile';
import type { RegisterHeaderProps } from './RegisterHeaderTypes';

export default function RegisterHeaderMobile({
  searchQuery,
  setSearchQuery,
  ...
  return (
    <div className="z-30 flex-shrink-0 border-b border-slate-200 bg-white px-3 py-3 sm:px-4">
      <div className="flex flex-col gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className={`h-11 w-11 flex-shrink-0 rounded-lg border-2 transition-all ${isScannerOpen ? 'border-slate-950 bg-slate-950 text-white' : 'border-slate-300 bg-white text-slate-700 hover:border-slate-500'}`}
