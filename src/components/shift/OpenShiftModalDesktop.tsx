...
export default function OpenShiftModalDesktop({
  open,
  title = 'Open shift',
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center p-0 sm:items-center sm:p-4">
      <div className="absolute inset-0 bg-slate-950/60 backdrop-blur-sm" onClick={() => allowClose && !isOpeningShift && onClose()} />
      <div className="relative z-10 w-full max-w-md rounded-t-lg border border-slate-300 bg-white p-5 shadow-2xl sm:rounded-lg">
        ...
        <div className={allowClose ? 'mt-5 grid grid-cols-[0.8fr_1.2fr] gap-2' : 'mt-5'}>
          {allowClose && (
            <button
              type="button"
              onClick={onClose}
