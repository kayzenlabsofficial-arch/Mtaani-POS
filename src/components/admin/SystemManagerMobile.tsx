...
export function ManageBusinessModal({ business, onClose }: ManageBusinessModalProps) {
  ...
  return (
    <div className="mobile-vv-overlay fixed inset-0 z-[200] flex items-center justify-center p-3 sm:p-6">
      <div className="absolute inset-0 bg-slate-950/80 backdrop-blur-xl animate-in fade-in" onClick={onClose} />
      <div className="mobile-vv-panel relative flex max-h-[92vh] w-full max-w-3xl flex-col overflow-hidden rounded-[2rem] border border-slate-800 bg-slate-900 shadow-2xl animate-in zoom-in-95">
        ...
        <div className="modal-scroll-padding overflow-y-auto p-5 sm:p-8">
...
export default function SystemManagerDashboardMobile({ onLogout }: { onLogout: () => void }) {
